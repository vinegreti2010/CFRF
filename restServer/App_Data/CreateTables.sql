...
CREATE TABLE facility_tbl (
  ...
  descr				VARCHAR(30),
  coordinate_north_east INTEGER,
  coordinate_north_west INTEGER,
  coordinate_south_east INTEGER,
  coordinate_south_west INTEGER,
...
CREATE TABLE class_attendence (
  ...
  PRIMARY KEY(class_nbr, strm, student_id, attend_dt),
